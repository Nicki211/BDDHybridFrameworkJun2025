...
/**
 * 
 * @author Dell This Class have common methods to configure the implicit and
 *         explicit waits
 *
 */
public class WaitMethods {
	 ...
	 * @return
	 * 
	 * This method will Wait for specific element condition to happen in Specified time mentioned in config.properties(Dynamic wait)
	 *
	 */
